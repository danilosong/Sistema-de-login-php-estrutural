                                    ...
                                    <form class="form-horizontal" name="formuser" enctype="multipart/form-data" action="inserir_cadastro.php" method="post"> 
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-offset-3 col-md-8 col-sm-9">
                                                ...
                                                <span class="text-muted"><span class="label label-danger">Atenção:</span> Eu concordo com os <a href ="#">Termos de Uso</a>, <a href ="#">EULA</a> e <a href ="#">Política de Privacidade.</a></span> </div>
                                        </div>
                                        <div class="form-group">
