                    ...
                    <div class="col-md-6 col-lg-4 col-lg-offset-4">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-xs-6 col-md-5 col-lg-6" align="center">
                                ...
                                <a href="cadastro_adm.php" class="btn btn-success btn-lg btn-block" role="button"><span class="glyphicon glyphicon-globe"></span>Criar novo administrador</a>
                            </div>
                        </div>
                    </div>
                </div>
